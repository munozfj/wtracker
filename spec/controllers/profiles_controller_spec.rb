  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved profile as @profile" do
        ...
        post :create, {:profile => { "user_id" => "invalid value" }}, valid_session
        assigns(:profile).should be_a_new(Profile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested profile" do
        ...
        Profile.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => profile.to_param, :profile => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the profile as @profile" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Profile.any_instance.stub(:save).and_return(false)
        put :update, {:id => profile.to_param, :profile => { "user_id" => "invalid value" }}, valid_session
        assigns(:profile).should eq(profile)
      end
