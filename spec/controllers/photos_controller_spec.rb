  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved photo as @photo" do
        ...
        post :create, {:photo => { "user_id" => "invalid value" }}, valid_session
        assigns(:photo).should be_a_new(Photo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested photo" do
        ...
        Photo.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => photo.to_param, :photo => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the photo as @photo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Photo.any_instance.stub(:save).and_return(false)
        put :update, {:id => photo.to_param, :photo => { "user_id" => "invalid value" }}, valid_session
        assigns(:photo).should eq(photo)
      end
